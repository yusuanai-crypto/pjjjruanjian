...
const sharedMenuEntries = <SharedMenuEntry>[
  ...
  SharedMenuEntry(id: 'today_travel_groups', label: '今日旅行团', phase: 3),
  ...
  SharedMenuEntry(id: 'guide_points_table', label: '导游积分表', phase: 7),
  ...
  SharedMenuEntry(id: 'special_orders', label: '内购/外销/回购', phase: 12),
  ...
  SharedMenuEntry(id: 'payment_method_management', label: '收款方式管理', phase: 6),
  ...
  SharedMenuEntry(id: 'warehouse_management', label: '库存管理', phase: 11),
  SharedMenuEntry(id: 'warehouse_directory', label: '仓库管理', phase: 11),
