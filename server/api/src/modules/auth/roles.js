...
const MENU_ENTRIES = {
  ...
  today_travel_groups: { id: 'today_travel_groups', title: '今日旅行团', phase: 3 },
  ...
  warehouse_management: { id: 'warehouse_management', title: '库存管理', phase: 11 },
  warehouse_directory: { id: 'warehouse_directory', title: '仓库管理', phase: 11 },
